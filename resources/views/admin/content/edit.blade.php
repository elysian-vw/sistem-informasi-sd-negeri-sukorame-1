...
<style>
    ...
    .form-control:disabled { background: #f9fafb; color: #9ca3af; border-color: #e5e7eb; cursor: not-allowed; }
...
<div class="page-header" style="margin-bottom: 24px;">
    <h1 class="page-title">Edit Konten Halaman: <span style="color: #2563eb;">{{ $page->title }}</span></h1>
    <p class="page-subtitle">Ubah struktur teks informasi, tabel, atau sisipkan gambar baru</p>
</div>
...
<div class="content-card">
    <div class="card-body" style="padding: 30px;">
        <form action="{{ route('admin.content.update', $page->slug) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="form-label">Konten Teks & Gambar Halaman <span style="color:#ef4444;">*</span></label>
                <textarea name="content" id="editor_halaman_edit" class="form-control" required>{{ $page->content }}</textarea>
                
                <script src="https://cdn.ckeditor.com/4.22.1/full/ckeditor.js"></script>
                <script>
                    setTimeout(function() {
                        if (document.getElementById('editor_halaman_edit')) {
                            CKEDITOR.replace('editor_halaman_edit', {
            ...
            <div class="btn-group">
                <button type="submit" class="btn btn-primary"><i class="fas fa-save" style="margin-right: 6px;"></i> Simpan Perubahan</button>
